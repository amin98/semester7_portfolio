...
const ResearchExistingTechPage = () => {
  const learningOutcomes = ['Analysis'];
  const subQuestion =
    'What tech do young people already use for entertainment and learning?';
  const pageTitle = 'Research: Existing Technology Usage';
  const pageDescription =
    'Analyzing the technology platforms and devices young people commonly use for entertainment and educational purposes.';
...
export default ResearchExistingTechPage;
