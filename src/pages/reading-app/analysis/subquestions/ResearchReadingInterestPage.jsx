...
const ResearchReadingInterestPage = () => {
  const learningOutcomes = ['Analysis'];
  const subQuestion =
    'What causes young people to lose interest in long-form reading?';
  const pageTitle = 'Research: Declining Interest in Reading';
  const pageDescription =
    'An investigation into the factors causing young people to lose interest in long-form reading.';
...
export default ResearchReadingInterestPage;
