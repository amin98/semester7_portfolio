...
const ResearchTeacherMotivationPage = () => {
  const learningOutcomes = ['Analysis'];
  const subQuestion = 'How do teachers currently try to motivate reading?';
  const pageTitle = 'Research: Teacher Motivation Strategies';
  const pageDescription =
    'Exploring the current methods teachers use to encourage and motivate students to read.';
...
export default ResearchTeacherMotivationPage;
