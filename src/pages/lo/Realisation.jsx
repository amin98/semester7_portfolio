  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <section id="rationale">
        ...
        <p className="text-base font-normal font-sans text-textSecondary leading-base">
          *Explain how the linked proof shows you are good at Realisation...*
        </p>
      </section>
    </div>
  );
